...
export default class Footer extends React.Component {
    render() {
        return (
            <footer id="footer" class={'wrapper ' + ((_.get(this.props, 'pageContext.frontmatter.template') === 'home') ? _.get(this.props, 'pageContext.site.data.footer.landing_style') : _.get(this.props, 'pageContext.site.data.footer.alt_style'))}>
                <div class="inner">
                    <ul class="menu">
                        <li>
